...
router.post('/', [validarJWT, esAdminRole, crearInstitucionValidator, validarCampos], institucionController.crear);
router.get('/', [validarJWT, esAdminRole], institucionController.listar);
router.get('/:id', [validarJWT, esAdminRole], institucionController.buscar);
router.put('/:id', [validarJWT, esAdminRole], institucionController.actualizar);
